...
## Cure Wounds
With the introduction of wounds as part of the death and dying rules the following change the cure wounds spell has been changed such that each casting can either

- Heal health as per the normal rules

- Remove 1 minor wound

This change is made to cure wounds so as to not have to introduce another spell and penalise casters with another spell the need to prepare.
